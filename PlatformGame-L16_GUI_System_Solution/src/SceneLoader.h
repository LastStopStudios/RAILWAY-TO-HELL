...
public:
	SceneLoader();
	~SceneLoader();
	void LoadScene(int level, int x, int y); // Aqui dentro se tendr�a que hacer tanto el Load de la siguiente escena como previamente el Unload
...
private:
	...
	void FadeOut(float speed); // Aparici�n del negro
