...
private:
    ...
    Animation idle, walk, punch, defeat, transform, idle2, salto, land, colatazo, transform2, idle3, attackH, attackV, death;
    ...
    float spearAttackCooldown = 3000.0f; // 3 seconds between attacks
