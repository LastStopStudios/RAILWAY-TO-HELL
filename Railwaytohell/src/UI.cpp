...
void UI::Boss3()
{
	...
	SDL_Rect vidaphase0 = { 550,posy2, wb, hb }; //Position and scale Boss health
	SDL_Rect vidaphase2 = { 670,posy2, wb, hb }; //Position and scale Boss health
	if(fase1){
		switch (vidab3)
		{
		case 0:
			SDL_RenderCopy(Engine::GetInstance().render->renderer, Evida, nullptr, &vidaphase0);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, Evida, nullptr, &vidaphase1);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, Evida, nullptr, &vidaphase2);//render  Boss health
			break;
		case 1:
			SDL_RenderCopy(Engine::GetInstance().render->renderer, vidaB3, nullptr, &vidaphase0);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, Evida, nullptr, &vidaphase1);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, Evida, nullptr, &vidaphase2);//render  Boss health
			break;
		case 2:
	...
	if (fase3) {
		...
		case 8:
			...
			SDL_RenderCopy(Engine::GetInstance().render->renderer, vidaB3, nullptr, &dstRect6);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, vidaB3, nullptr, &dstRect7);//render  Boss health
			SDL_RenderCopy(Engine::GetInstance().render->renderer, vidaB3, nullptr, &dstRect8);//render  Boss health
			break;
		}
	}
